...
>
      <div>
        ...
        >
          <Typewriter words={["PRENONS CONTACT !"]} loop={true} />
          &nbsp;
        </h2>
      </div>
      <div className="w-full flex justify-center">
        ...
        >
          ...
          <label htmlFor="firstname" style={{ fontWeight: 'bold', fontSize: '18px' }}>Nom</label>
            <input
          ...
          <div className="w-full flex flex-col">
          <label htmlFor="lastname" style={{ fontWeight: 'bold', fontSize: '18px' }}>Prenoms</label>
            <input
              className="p-[0.5em] rounded-xl text-grayscale-950 bg-primary-200"
